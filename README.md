...
#### Package Manager:
```ps
Install-Package Excubo.Blazor.LazyStyleSheet -Version 2.0.0
```

#### .NET Cli:
```cmd
dotnet add package Excubo.Blazor.LazyStyleSheet --version 2.0.0
```

#### Package Reference
```xml
<PackageReference Include="Excubo.Blazor.LazyStyleSheet" Version="2.0.0" />
```
